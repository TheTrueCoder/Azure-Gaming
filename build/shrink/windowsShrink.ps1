# Variables
$rgName = "windowsShrink_imageBuild"
...
Write-Output $pswdStr

# Make RG
New-AzResourceGroup -Name $rgName -Location $location

# Pre guest resize
$VM = New-AzVM -ResourceGroupName $rgName -Name $VMName -Credential $creds -Image Win2019Datacenter
Invoke-AzVMRunCommand -ResourceGroupName $rgName -Name $VMName -CommandId 'RunPowerShellScript' -ScriptPath _shrinkpartition.ps1
...
## Finish guest
Invoke-AzVMRunCommand -ResourceGroupName $rgName -Name $VMName -CommandId 'RunPowerShellScript' -ScriptPath _finishbuild.ps1
